...
export default function AdminPage() {
  ...
  async function setResult(match: Match, hs: string, as: string) {
    ...
    setStatus(error ? "Не удалось сохранить результат." : "Результат сохранён, очки пересчитаны автоматически.");
    await load();
  }
